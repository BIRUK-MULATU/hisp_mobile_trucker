            ...
            children: [
              ...
              Expanded(
                child: Column(
                  ...
                  // Size to content and center vertically — the card
                  // lives in fixed-extent grid tiles, so a Column
                  // that fills the tile overflows instead of fitting.
                  ...
                  children: [
                    ...
                    // Status chips row — chips shrink (ellipsizing
                    // their label) rather than overflow when the
                    // tile is narrow.
                    Row(
                      children: [
                        Flexible(
                          child: _StatusChip(
                            ...
                            isActive: dataSet.syncStatus == SyncStatus.synced,
